...
public class Stepdefs {
    ...
    @When("^username \"([^\"]*)\" and password \"([^\"]*)\" are entred$")
    public void username_and_password_are_entred(String username, String password) throws Throwable {
        inputLines.add(username);
        inputLines.add(password);
    ...
    @When("^username \"([^\"]*)\" nad password \"([^\"]*)\" are entered$")
    public void username_nad_password_are_entered(String username, String password) throws Throwable {
        inputLines.add(username);
        inputLines.add(password);
